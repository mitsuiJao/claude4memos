...
```bash
mkdir -p claude4memos && cd claude4memos
curl -O https://raw.githubusercontent.com/mitsuijao/claude4memos/main/docker-compose.yml
curl -O https://raw.githubusercontent.com/mitsuijao/claude4memos/main/.env.example
cp .env.example .env
```
